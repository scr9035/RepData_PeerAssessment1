...
text(x=8000,y=10, label="mean", col="blue")                               #add text labeling to abline
text(x=12500,y=10, label="median", col="red")                             #add text labeling to abline
...
plot(mean_steps_in_a_day$time, mean_steps_in_a_day$steps, type="l",
     main = "Avg number of steps taken during a 24 hour period",
     xlab="Time of day",
...
text(x=17000,y=12, label="Notice large frequency right at", col="blue", cex=1)
text(x=17200,y=11, label="mean number of steps per day", col="blue", cex=1)
...
abline(v=median_sum,col="red", lwd=5)
abline(v=mean_sum,col="blue", lwd=3)
text(x=17000,y=12, label="Now notice a smaller frequency at", col="blue", cex=1)
text(x=17200,y=11, label="mean number of steps per day", col="blue", cex=1)
